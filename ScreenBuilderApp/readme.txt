There are several improvements available in this application:
...
Improved drag and drop functionality: In order to perform drag and drop operations, it is necessary to select the item before attempting the action. This can be improved